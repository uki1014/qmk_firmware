...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER0] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT,
                         	KC_LCTL, LAYER1,                                                        LAYER2, KC_LCTL,
                                                     KC_LGUI, LSFT(KC_SPC), KC_ENT, LAYER3,
                                                     KC_TAB,  KC_ESC,  KC_LNG1,  KC_LCTL,
                                                     LAYER1,   KC_NO,   KC_Y, LAYER2
    ),
    ...
    [_LAYER3] = LAYOUT(
        _______, _______, KC_MU,   _______, _______,                                      KC_VOLU, _______, KC_UP,   _______, KC_PGUP,
        _______, KC_ML,   KC_MD,   KC_MR,   _______,                                      KC_MUTE, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,
        _______, _______, _______, _______, _______,                                      KC_VOLD, KC_BSPC, KC_BSLS, KC_QUES, KC_PIPE,
                 _______, _______,                                                                          KC_MB1,  KC_MB2,
                                   _______, _______,                                      _______, _______,
                                                     _______, _______,  _______, _______,
